...
namespace RayTracingEngine
{
	...
	bool CLoad3DS::Import3DS(CScene *pModel, char *strFileName)
	{
	...
	void CLoad3DS::ProcessNextChunk(CScene *scene, tChunk *pPreviousChunk)
	{
		CModel newObject = { 0 };
		CMaterial newTexture = { 0 };
		...
		while (pPreviousChunk->bytesRead < pPreviousChunk->length)
		{
			...
			case OBJECTINFO:						// This holds the version of the mesh
			{
														...
														ProcessNextChunk(scene, &currentChunk);
														break;
			}
			case MATERIAL:							// This holds the material information
				...
				scene->materials.push_back(newTexture);

				// Proceed to the material loading function
				ProcessNextMaterialChunk(scene, &currentChunk);
				break;
	...
	void CLoad3DS::ProcessNextObjectChunk(CScene *pModel, CModel *pObject, tChunk *pPreviousChunk)
	{
	...
	void CLoad3DS::ProcessNextMaterialChunk(CScene *pModel, tChunk *pPreviousChunk)
	{
		// The current chunk to work with
		tChunk currentChunk = { 0 };
	...
	void CLoad3DS::ReadColorChunk(CMaterial *pMaterial, tChunk *pChunk)
	{
		tChunk tempChunk = { 0 };
	...
	void CLoad3DS::ReadVertexIndices(CModel *pObject, tChunk *pPreviousChunk)
	{
	...
	void CLoad3DS::ReadUVCoordinates(CModel *pObject, tChunk *pPreviousChunk)
	{
	...
	void CLoad3DS::ReadVertices(CModel *pObject, tChunk *pPreviousChunk)
	{
	...
	void CLoad3DS::ReadObjectMaterial(CScene *pModel, CModel *pObject, tChunk *pPreviousChunk)
	{
